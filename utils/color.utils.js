/*--------- Try colors here ----------*/
export const RGB = 'rgb(0,0,255)';
export const RGB_P = 'rgb(0%,0%,100%)';
export const RGBA = 'rgba(0,0,255,0.5)';
export const RGBA_P = 'rgba(0%,0%,100%,0.5)';
export const HEX = '#0000ff';
export const HEXA = '#0000ff80';
export const HSL = 'hsl(240,100%,50%)';
export const HSLA = 'hsla(240,100%,50%,0.5)';
